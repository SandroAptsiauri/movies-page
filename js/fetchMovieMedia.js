    ...
    if (resTrailers.results && resTrailers.results.length !== 0) {
      resTrailers.results.slice(0, 10).forEach((cur) => {
        ...
        play_icon_svg.style.cssText =
          "width: 50%; height: 50%; left: 1px; filter: invert(100%) brightness(120%) contrast(100%); transition: opacity 200ms linear; background-image: url('/movies-page/assets/glyphicons-basic-175-play-806cb05551791b8dedd7f8d38fd3bd806e2d397fcfeaa00a5cc9129f0819fd07.svg');";
